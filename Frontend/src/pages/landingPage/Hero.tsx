            ...
            {name}!
                    ...
                    >
                        <Link to="/dashboard/booking_form">
                            <button className="btn text-white hover:text-black bg-orange-700 hover:bg-orange-600 transition-all duration-300 px-8 py-3 rounded-full text-lg lg:text-xl">
                                Book Now!!
                            </button>
                        </Link>
                    </motion.div>
