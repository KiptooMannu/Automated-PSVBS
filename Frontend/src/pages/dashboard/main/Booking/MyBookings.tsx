            ...
            <table className="min-w-full bg-white">
              <thead className="bg-gray-800 text-white">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-sm font-medium uppercase">Seats ID</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {userBookings.map((booking) => (
                  <tr key={booking.booking_id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-700">{getSeatIds(booking.booking_id)}</td>
