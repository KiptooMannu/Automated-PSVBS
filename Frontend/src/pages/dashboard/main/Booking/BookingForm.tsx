...
//   // const [selectedSeat, setSelectedSeat] = useState<string | null>(null); // Selected seat
//   const [isMapSeatModalOpen, setIsMapSeatModalOpen] = useState(false);

//   //handle map seat modal
//   const handleMapSeatModal = () => {
...
//     toast.success(`Book for vehicle: ${selectedVehicle.vehicle_name}`);
...
// >
//   select seat
//   {/* <Link to="/map_seat" className="flex items-center">Select Seat</Link> */}
// </button>
...
//   <MapSeatModal onClose={() => setIsMapSeatModalOpen(false)} />
// )}
